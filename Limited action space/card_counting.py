...
-------------------------------------------------------------------------------
the agent tracks the total value of cards played ("running count") based on which he decides how much he bets in the next round
Here we use Hi_Lo counting strategy. It is not the best but it is the simpliest. Its main advantage is that it is the same regardless of the number of decks used.
...
class count_agent(agent):
    ...
    def count_cards(self, hand): # returns the running count (it is called after each round of the game)
        hi_lo = {'2': 1, '3': 1, '4': 1, '5': 1, '6': 1, '7': 0, '8': 0, '9': 0, '10': -1, 'J': -1, 'Q': -1, 'K': -1, 'A': -1} # counting rules
